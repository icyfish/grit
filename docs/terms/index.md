...
- Start in low Squat position, feet outside hip-width
  - 低蹲位起始, 脚宽超过髋宽
- Hands to floor, palms flat
  - 手掌平撑住地板
- Kick legs out and up at 45° angle
  - 双腿向后踢, 与地面呈45度角.
- Land back in low Squat position with chest
lifted
	- 以低蹲位姿势回到地面, 抬起胸部.
- Abs braced to kick back
  - 踢回同时收腹
- Both feet take off and land in Bronco and
Jump
	- 双脚同时离地后跳起
...
- Start in Plank position
  - 平板位起始
- Jump knees into chest, then shoot feet back to
Plank position
	- 俯身, 双膝跳跃至胸口位置, 之后快速回平板位
- Abs braced
...
- Pushup (x1), then jump feet into Bear Crawl position
  - 1次俯卧撑后跳回至熊爬姿势
- Hands under shoulders, knees in line with hips
  - 四足撑地
- Rotate body 180 degrees, keeping butt down
  - 身体旋转 180 度, 保持臀部向下
- Jump feet back out to Plank position with abs
braced
	- 收腹跳回平板位
...
- Keep lower back and waist towards floor by bracing the abs
  - 绷紧腹部, 下背部和腰紧贴地板
- Shoulders and head anchored to floor
  - 肩膀和头部扣牢地板
- Back shoulder stays down as legs drop to
45 degrees
	- 腿落到45度位置时, 肩膀后侧始终保持贴紧地面 
...
- Chin tucked in
  - 下巴往内收
- Aim opposite shoulder to knee
  - 肩膀与对侧膝盖相对
- Brace abs to keep lower back towards floor
  - 绷紧腹部保持下背部紧贴地板
- Slide ribs to hips
  - ?
- **OPTION:** Tap Foot down
